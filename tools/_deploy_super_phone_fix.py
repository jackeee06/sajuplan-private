...
s = c.open_sftp()
local = r"C:\claudeworkspace\sajumoon\api\dist\admin\members\members.controller.js"
remote = "/data/wwwroot/api.sajumoon.co.kr/dist/admin/members/members.controller.js"
s.put(local, remote)
