"""sms.service.js (alimtalk_log 로깅 포함) prod 배포."""
...
s = c.open_sftp()
local = r"C:\claudeworkspace\sajumoon\api\dist\user\sms\sms.service.js"
remote = "/data/wwwroot/api.sajumoon.co.kr/dist/user/sms/sms.service.js"
s.put(local, remote)
print(f"[uploaded sms.service.js] size={s.stat(remote).st_size}")
s.close()
