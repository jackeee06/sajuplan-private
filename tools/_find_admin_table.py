"""admin 비슷한 테이블 + 사장님 계정 is_super 찾기."""
import os, sys
...
SELECT table_name FROM information_schema.tables
 WHERE table_schema='public' AND (table_name LIKE '%admin%' OR table_name LIKE '%adm%')
 ORDER BY table_name;

-- is_super 컬럼이 있는 모든 테이블
SELECT table_name, column_name
  FROM information_schema.columns
 WHERE table_schema='public' AND column_name='is_super';
"""
