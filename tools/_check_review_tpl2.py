...
try:
    q(c,"SELECT template_code, primary_btn_name, primary_btn_type, primary_btn_url FROM alimtalk_template WHERE template_code='review_for_counselor_v2'","버튼설정")
    q(c,"SELECT buttons::text FROM alimtalk_template WHERE template_code='review_for_counselor_v2'","buttons JSON")
finally:
    c.close()
print("done")
