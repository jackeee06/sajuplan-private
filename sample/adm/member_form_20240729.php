...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td><?php echo get_member_level_select('mb_level', 1, $member['mb_level'], $mb['mb_level']) ?> 일반/상담사 <a href="../bbs/write.php?w=u&bo_table=counselor&wr_id=21" class="btn btn_01" target="_blank">상담사 프로필</a></td>
        <th scope="row">포인트</th>
    ...
    <tr>
	 ...
	 <tr>
        <th scope="row"><label for="mb_1">상담사 번호<strong class="sound_only">필수</strong></label></th>
        <td><input type="text" name="mb_1" value="<?php echo $mb['mb_1'] ?>" id="mb_1"  class="frm_input" size="30" readonly></td>
	 ...
	 <tr>
        ...
        <th scope="row"><label for="mb_4">회원차감단위금액</label></th>
        <td><input type="text" name="mb_4" value="<?php echo $mb['mb_4'] ?>" id="mb_4" class="frm_input" size="15" maxlength="20"></td>
    </tr>

	 <tr>
        <th scope="row"><label for="mb_5">회원차간단위시간(초)<strong class="sound_only">필수</strong></label></th>
        <td><input type="text" name="mb_5" value="<?php echo $mb['mb_5'] ?>" id="mb_5" maxlength="100" class="frm_input" size="30"></td>
	 ...
	 <tr>
        <th scope="row"><label for="state">상담사 상태<strong class="sound_only">필수</strong></label></th>
        <td>
...
<?php if($member['mb_level']>2){ //권한2보다 높은 권한일 경우 ?>
