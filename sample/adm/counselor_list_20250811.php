...
//20250731 eun RDVC 추가
                ...
                $sql_search .= " ({$sfl} !='IDLE' and {$sfl} !='RDVC') ";
//			$sql_search .= " ({$sfl} !='IDLE') ";
...
$sql = " select count(*) as cnt {$sql_common} where a.mb_level='5' and (a.state='IDLE' or a.state='RDVC') ";
...
?>
    ...
    -->
        ...
        <span class="btn_ov01"><span class="ov_txt03">상담가능 </span><span class="ov_num"><a href="?sfl=a.state&stx=IDLE,RDVC"> <?php echo number_format($id_count) ?>명 </a></span></span>
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <div class="tbl_head01 tbl_wrap">
                ...
                <table>
                    ...
                    for ($i=0; $row=sql_fetch_array($result); $i++) {
                        ...
                        <tr class="<?php echo $bg; ?>" data-index="<?php echo $i; ?>">
                            ...
                            <td headers="mb_list_order"><!--상담사 추천 순서--><input type="number" name="mb_sort[<?php echo $i; ?>]" min="1" max="20" style="width:40px; text-align:center;"
            	...
            	<input id="ev_4" type="checkbox" name="ev_4[<?php /*echo $i */?>]" value="Y" <?/*if($row["ev_4"]=="Y"){echo "checked";}*/?>/>
                                ...
                                <label for="mb_rising">
                                    <input type="number" name="mb_rising[<?php echo $i; ?>]" min="1" max="20" style="width:40px; text-align:center;"
