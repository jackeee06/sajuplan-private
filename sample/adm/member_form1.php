...
.frm_info { margin:5px 0 0 0 !important;}
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="radio" name="mb_10" value="남"<?php echo ($mb['mb_10'] == "남") ? " checked" : "";?>> 남자

            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

			<input type="radio" name="mb_10" value="여"<?php echo ($mb['mb_10'] == "여") ? " checked" : "";?>> 여자
    ...
    <tr>
		...
		$sql1 = "select * from g5_write_counselor where mb_id='".$mb["mb_id"]."'";
		...
		if($mrow["wr_id"]){
			...
			$purl = "&wr_id=".$mrow["wr_id"]."&tmb_id=".$mb["mb_id"];

			$w = "u";

		}else{

			$purl = "&tmb_id=".$mb["mb_id"];
		...
		?>
			...
			상담사 / <a href="../bbs/write.php?w=<?=$w?>&bo_table=counselor<?=$purl?>" class="btn btn_01" target="_blank">상담사 프로필</a>
    ...
    <tr>
	 ...
	 <tr>
        ...
        <th scope="row"><label for="mb_point">회원코인금액<strong class="sound_only">필수</strong></label></th>

        <td><input type="text" name="mb_point" value="<?php echo $mb['mb_point'] ?>" id="mb_point" class="frm_input" size="30" readonly></td>

        <th scope="row"><label for="mb_1"><?if($mb["mb_level"]=="2"){echo "mtonet 회원번호";}?></label></th>

        <td><?if($mb["mb_level"]=="2"){echo $mb["mb_1"];}?></td>
    ...
    <tr>
        ...
        <td>
        	...
        	<input type="date" name="mb_birth" value="<?php echo isset($mb['mb_birth'])?$mb['mb_birth']:''; ?>" id="mb_birth" class="frm_input" size="15" maxlength="50" placeholder="1988-06-22">

            

            <input type="radio" name="mb_11" value="양력"<?php echo ($mb['mb_11'] == "양력") ? " checked" : "";?>> 양력

            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

			<input type="radio" name="mb_11" value="음력"<?php echo ($mb['mb_11'] == "음력") ? " checked" : "";?>> 음력
...
<?php 
	...
	if($mb['mb_level'] == 5){ //권한4보다 높은 권한일 경우
...
<section class="sub_wrap" id="manager_div" style="display:<?=$sdsp?>">



<h2 class="h2_frm">상담사 전용</h2>
...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
        <th scope="row"><label for="mb_no">상담사번호<strong class="sound_only">필수</strong></label></th>
        <td><input type="text" name="mb_no" value="<?php echo $mb['mb_no'] ?>" id="mb_no"  class="frm_input" size="15" ></td>
        <th scope="row">
            <label for="mb_1">엠투넷번호(상담사ID)<strong class="sound_only">필수</strong></label>
        </th>
        <td>
            <input type="text" name="mb_1" value="<?php echo $mb['mb_1'] ?>" id="mb_1"  class="frm_input" size="15">
            <?php
            if($mb['mb_1'] == ""){
            ?>
              <button type="button" class="btn_frmline" onclick="onReconnect();">재 연동하기</button><br>
            <?php
            }
            ?>
	...
	<tr>
	 ...
	 <th scope="row"><label for="mb_3">상담사 실제연결 전화번호<strong class="sound_only">필수</strong></label></th>

        <td><input type="text" name="mb_3" value="<?php echo $mb['mb_3'] ?>" id="mb_3" maxlength="100" class="frm_input" size="30"></td>

        <th scope="row"><label for="mb_2">상담사 연결순위</label></th>

		

        <td><input type="text" name="mb_2" value="<?php echo $mb['mb_2'] ?>" id="mb_2" class="frm_input" size="15"></td>  
	 ...
	 <tr style="column-span: 6;">
        ...
        <th scope="row"><label for="mb_5">회원차감 단위시간<strong class="sound_only">필수</strong></label></th>

        <td><input type="text" name="mb_5" value="<?php echo $mb['mb_5'] ?>" id="mb_5" maxlength="100" class="frm_input" size="15">초</td>

        <th scope="row"><label for="mb_6">선불여부</label></th>

        <td>

			<select name="mb_6" id="mb_6">

				<option value="P" <?if($mb["mb_6"]=="P"){echo "selected";}?>>둘다</option>

				<option value="" <?if($mb["mb_6"]==""){echo "selected";}?>>후불</option>

				<option value="Y" <?if($mb["mb_6"]=="Y"){echo "selected";}?>>선불</option>

			</select>
            <script>
                 <?php if(empty($mb['mb_6']) && $w == ''): ?>
                    $("#mb_6").val("P");
                 <?php endif; ?>
            </script>
	 ...
	 <tr>
        ...
        <th scope="row"><label for="mb_9">060 회원차감단위금액</label></th>

        <td><input type="text" name="mb_9" value="<?php echo $mb['mb_9'] ?>"  id="mb_9" class="frm_input" size="15" maxlength="20">원</td>



        <th scope="row"><label for="mb_4">070 회원차감단위금액</label></th>

        <td><input type="text" name="mb_4" value="<?php echo $mb['mb_4'] ?>" id="mb_4"   class="frm_input" size="15" maxlength="20">원</td>

    </tr>
<?php //  if($_SERVER['REMOTE_ADDR'] == "115.93.39.5"){ ?>
    <!-- wb 250807 추후 250812 에 적용 예정 -->
     <tr>

        <th scope="row"><label for="mb_12">채팅상담 차감단위시간</label></th>

        <td><input type="text" name="mb_12" value="<?php echo $mb['mb_12'] ?>"  id="mb_12" class="frm_input" size="15" maxlength="20">초</td>



        <th scope="row"><label for="mb_13">채팅상담 차감단위금액</label></th>

        <td><input type="text" name="mb_13" value="<?php echo $mb['mb_13'] ?>" id="mb_13"   class="frm_input" size="15" maxlength="20">원</td>
...
<!--    --><?php //} ?>
    ...
    <tr>
        ...
        <td colspan="3">
			...
			$mb["mb_8"]?$mb_8s = explode("|",$mb["mb_8"]):$mb_8s=array();

			?>

            <input type="text" name="mb_8_2" value="<?php echo $mb_8s[1] ?>" id="mb_8_2" class="frm_input" size="8"  maxlength="20" placeholder="예금주">

        	<input type="text" name="mb_8_1" value="<?php echo $mb_8s[0]?>" id="mb_8_1" class="frm_input" size="15"  maxlength="20" placeholder="은행명">	        

	        <input type="text" name="mb_8_3" value="<?php echo $mb_8s[2] ?>" id="mb_8_3" class="frm_input" size="15"  maxlength="20" placeholder="계좌번호">
	...
	<tr>
        ...
        <th scope="row">무료 로열티</th>
        <td>
			<input type="text" name="mb_19" value="<?php echo $mb['mb_19'] ?>" id="mb_19" class="frm_input" size="15" maxlength="20">%     
        </td>
        <th scope="row">유료 로열티</th>
        <td>
			<input type="text" name="mb_20" value="<?php echo $mb['mb_20'] ?>" id="mb_20" class="frm_input" size="15" maxlength="20">%     
        </td>
    </tr>
			...
			<table>
				...
				<tr>
					...
					<td >
						...
						<div class="filebox bs3-primary preview-image<?=$a;?>">

							<input class="upload-name<?=$a;?>"  disabled="disabled" >

							<label for="input_file<?=$a;?>">찾아보기</label>

							<input type="file" id="input_file<?=$a;?>" class="upload-hidden<?=$a;?>" name="bf_file[]" title="파일첨부 <?php echo $i+1 ?> : 용량 <?php echo $upload_max_filesize ?> 이하만 업로드 가능">
				...
				<script>
					...
					$(document).ready(function () {
						...
						var imgTarget2 = $('.preview-image2 .upload-hidden2');
						...
						imgTarget.on('change', function () {
							...
							if (window.FileReader) {
								...
								reader.onload = function (e) {
									...
									parent.prepend('<div class="upload-display1"><div class="upload-thumb-wrap1"><img src="' + src + '" class="upload-thumb"></div></div>');
								...
								parent.prepend('<div class="upload-display1"><div class="upload-thumb-wrap1"><img class="upload-thumb"></div></div>');
						...
						imgTarget2.on('change', function () {
							...
							if (window.FileReader) {
								...
								reader.onload = function (e) {
									...
									parent.prepend('<div class="upload-display2"><div class="upload-thumb-wrap2"><img src="' + src + '" class="upload-thumb"></div></div>');
								...
								parent.prepend('<div class="upload-display2"><div class="upload-thumb-wrap2"><img class="upload-thumb"></div></div>');
...
<!--             <input type="number" name="mb_sort" value="--><?php //echo isset($mb['mb_sort']) ? $mb['mb_sort'] : '-'; ?><!--" min="1" max="20" style="width:60px;">-->
             <input type="number" name="mb_sort" class="frm_input"
                    value="<?php echo (isset($mb['mb_sort']) && $mb['mb_sort'] != 0) ? $mb['mb_sort'] : ''; ?>"
                    min="1" max="20" style="width:60px;" placeholder="-" >
         </td>

         <th>급상승 상담사</th>
         <td>
<!--             <input type="number" name="mb_rising" value="--><?php //echo isset($mb['mb_rising']) ? $mb['mb_rising'] : '-'; ?><!--" min="1" max="20" style="width:60px;">-->
             <input type="number" name="mb_rising" class="frm_input"
                    value="<?php echo (isset($mb['mb_rising']) && $mb['mb_rising'] != 0) ? $mb['mb_rising'] : ''; ?>"
                    min="1" max="20" style="width:60px;" placeholder="-" >
         </td>
     </tr>

     <!--20250731 EUN 순위 표시  추가 마감-->


     <tr>

        <th scope="row">상담사 상태</th>

        

        <td>

			<?php if($mb['mb_level'] == 5){ //권한4보다 높은 권한일 경우 ?>

			<select name="state" id="state" style=" border:2px solid #ff4081; color:#ff4081; border-radius: 5px;" >
                <!--20250731 EUN RDVC 추가 시작-->
                <!--<option value="IDLE" --><?//if($mb["state"]=="IDLE"){echo "selected";}?><!--상담가능</option>-->
                <option value="IDLE" <?php if($mb["state"]=="IDLE" || $mb["state"]=="RDVC"){echo "selected";} ?>>상담가능</option>
                <!--20250731 EUN RDVC 추가 마감-->

				<option value="ABSE" <?if($mb["state"]=="ABSE"){echo "selected";}?>>부재중</option>

				<option value="CONN" <?if($mb["state"]=="CONN"){echo "selected";}?>>상담중</option>

				<option value="RESV" <?if($mb["state"]=="RESV"){echo "selected";}?>>예약</option>

				<option value="CRDY" <?if($mb["state"]=="CRDY"){echo "selected";}?>>상담준비</option>
        ...
        <td>
        	...
        	<div style="display:inline-block; line-height:35px; margin-right:40px;">

            	전화상담

                &nbsp;

	        	<select name="use_phone" id="use_phone" style=" border:2px solid #ff4081; color:#ff4081; border-radius: 5px;" >

					<option value="Y" <?if($mb["use_phone"]=="Y"){echo "selected";}?>>사용</option>

					<option value="N" <?if($mb["use_phone"]=="N"){echo "selected";}?>>미사용</option>
            ...
            <div style="display:inline-block; line-height:35px;">
				...
				<select name="use_chat" id="use_chat" style=" border:2px solid #ff4081; color:#ff4081; border-radius: 5px;" >

					<option value="N" <?if($mb["use_chat"]=="N"){echo "selected";}?>>미사용</option>

					<option value="Y" <?if($mb["use_chat"]=="Y"){echo "selected";}?>>사용</option>
