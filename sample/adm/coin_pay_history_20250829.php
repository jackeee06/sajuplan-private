...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" id="mb_list_mng"><?php echo subject_sort_link('Amount', '', 'desc') ?>결제금액</th>
        <th scope="col" id="mb_list_mng"><?php echo subject_sort_link('Coin_Amount', '', 'desc') ?>충전금액</th>
        <!--<th scope="col" id="mb_list_mng">사용자 등급</th>-->
        <th scope="col" id="mb_list_mng"><?php echo subject_sort_link('ResultMsg', '', 'desc') ?>결과</th>
    </tr>
    </thead>
    <tbody>
    <?php
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <!--<td><?=$row["mb_level"]?></td>-->
<!--        20250829 eun 결제 취소 처리 부분 작업 시작-->
        <td><?
