       ...
       <div id="logo"><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>"><img src="<?php echo G5_ADMIN_URL ?>/img/logo.png" alt="<?php echo get_text($config['cf_title']); ?> 관리자"></a></div>
        ...
        <div id="tnb">
            <ul>
                ...
                <?php } ?>
                -->
                <li class="tnb_li"><a href="<?php echo G5_URL ?>/" class="tnb_community" target="_blank" title="앱 바로가기">앱 바로가기</a></li>
...
<div id="wrapper">
    ...
    <div id="container" class="<?php echo $adm_menu_cookie['container']; ?>">
        ...
        <h1 id="container_title" style=" text-transform:uppercase; font-weight:900;">
			Dashboard <?php //echo $g5['title'] ?>
            <div class="today">
				<? echo $now = date("Y-m-d"); ?> 
			    <? 
