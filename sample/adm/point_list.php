...
<div class="local_ov01 local_ov">
    ...
    if (isset($mb['mb_id']) && $mb['mb_id']) {
        ...
        echo '&nbsp;<span class="btn_ov01"><span class="ov_txt">전체 합계</span><span class="ov_num">'.number_format($sum_point).'점 </span></span>';
    }
    ?>
</div>
...
<a href="point_list_excel.php?<?=$qstr?>"><input type="submit" name="" value="엑셀다운로드" onclick="" class="btn btn_excel" style=" float:right;"></a>
