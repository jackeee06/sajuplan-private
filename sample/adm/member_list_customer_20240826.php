...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" class="gray_bg">성별</th>
        <th scope="col" class="gray_bg">연령</th>
        <th scope="col" class="gray_bg">결제건수</th>
        <th scope="col" class="gray_bg">누적결제금액</th>
        <th scope="col" class="gray_bg">가입경과일</th>
        <th scope="col" class="gray_bg">가입출처</th>
        <th scope="col" id="mb_list_lastcall"><?php echo subject_sort_link('mb_today_login', '', 'desc') ?>최근접속일</a></th>
        <th scope="col" class="gray_bg">방문횟수</th>        
        <th scope="col" class="gray_bg">단말기기종</th>    
        <th scope="col" class="gray_bg">쿠폰 사용 개수</th>  
        <th scope="col" class="gray_bg">무료 상담 여부</th>
        <th scope="col" class="gray_bg">유료 상담 여부</th>
        <th scope="col" class="gray_bg">고객 구분</th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_join" class=""><?php echo substr($row['mb_datetime'],2,8); ?></td>
