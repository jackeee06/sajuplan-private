...
$menu['menu100'] = array (
    ...
    //20250811 eun 세션, 캐시, 캡챠, 썸네일 삭제 부분 개발환경에서만 보이게 수정 시작
    ...
    // array('100920', '썸네일파일 일괄삭제',G5_ADMIN_URL.'/thumbnail_file_delete.php',   'cf_thumbnail', 1),//20250811 eun 세션, 캐시, 캡챠, 썸네일 삭제 부분 개발환경에서만 보이게 수정 마감
    // array('100500', 'phpinfo()',        G5_ADMIN_URL.'/phpinfo.php',       'cf_phpinfo')
);

// if($_SERVER['REMOTE_ADDR'] == "115.93.39.5"){
//    // $menu['menu100'][] = array('100800', '세션파일 일괄삭제', G5_ADMIN_URL . '/session_file_delete.php', 'cf_session', 1);
//    // $menu['menu100'][] = array('100900', '캐시파일 일괄삭제', G5_ADMIN_URL . '/cache_file_delete.php', 'cf_cache', 1);
//    // $menu['menu100'][] = array('100910', '캡챠파일 일괄삭제', G5_ADMIN_URL . '/captcha_file_delete.php', 'cf_captcha', 1);
//     $menu['menu100'][] = array('100920', '썸네일파일 일괄삭제', G5_ADMIN_URL . '/thumbnail_file_delete.php', 'cf_thumbnail', 1);
// }
