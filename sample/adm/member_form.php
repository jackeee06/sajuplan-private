...
?>
    ...
    <form name="fmember" id="fmember" action="./member_form_update.php" onsubmit="return fmember_submit(this);" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="mb_20" value="<?php echo $mb['mb_20'] ?>" id="mb_20" class="frm_input" size="15" maxlength="20">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="mb_id" value="<?php echo $mb['mb_id'] ?>" id="mb_id" <?php echo $required_mb_id ?> class="frm_input <?php echo $required_mb_id_class ?>" size="50"  maxlength="200">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="mb_hp" value="<?php echo format_phone(str_replace("-","",($mb['mb_hp']))); ?>" id="mb_hp" class="frm_input" size="15" maxlength="20"></td>
                    ...
                    <tr>
                        ...
                        <th scope="row"><label for="org_source">가입경로<strong class="sound_only">필수</strong></label></th>

                        <td><input type="text" name="org_source" value="<?php echo $mb['org_source'] ?>" id="org_source" maxlength="100" class="frm_input " size="30"></td>
            ...
            <div class="tbl_frm01 tbl_wrap">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <th scope="row"><label for="mb_1">엠투넷번호(상담사ID)<strong class="sound_only">필수</strong></label></th>

                        <td><input type="text" name="mb_1" value="<?php echo $mb['mb_1'] ?>" id="mb_1"  class="frm_input" size="15" readonly></td>
                    ...
                    <tr>
                        ...
                        <th>급상승 상담사</th>
                        <td>
                            <input type="number" name="mb_rising"  class="frm_input"  value="<?php echo isset($co_row['mb_rising']) ? $co_row['mb_rising'] : ''; ?>" min="1" max="20" style="width:60px;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if($mb['mb_level'] == 5){ //권한4보다 높은 권한일 경우 ?>
                                ...
                                <select name="state" id="state" style=" border:2px solid #8259f5; color:#8259f5; border-radius: 5px;" >
                                    <!--20250731 EUN RDVC 추가 시작-->

                                    <!--				<option value="IDLE" --><?//if($mb["state"]=="IDLE"){echo "selected";}?><!--상담가능</option>-->
                                    <option value="IDLE" <?php if($mb["state"]=="IDLE" || $mb["state"]=="RDVC" || $mb["state"]=="RDCH"){echo "selected";} ?>>상담가능</option>

                                    <!--20250731 EUN RDVC 추가 마감-->

                                    <option value="ABSE" <?if($mb["state"]=="ABSE"){echo "selected";}?>>부재중</option>

                                    <option value="CONN" <?if($mb["state"]=="CONN"|| $mb["state"]=="CNCH"){echo "selected";}?>>상담중</option>
                        ...
                        <td>
                            ...
                            <div style="display: flex; align-items: center;">
                                ...
                                <div style="display:inline-block; line-height:35px; margin-right:40px;">
                                    ...
                                    <select name="use_phone" id="use_phone" style=" border:2px solid #8259f5; color:#8259f5; border-radius: 5px;" >
                                ...
                                <div style="display:inline-block; line-height:35px;">
                                    ...
                                    <select name="use_chat" id="use_chat" style=" border:2px solid #8259f5; color:#8259f5; border-radius: 5px;" >
