...
<a href="#none;" onclick="pay_month();"><input type="button" class="btn btn_excel" style=" float:right;" value="월정산하기"></a>



<a href="settlement_list_excel.php?<?=$qstr?>"><input type="submit" name="" value="엑셀다운로드" onclick="" class="btn btn_excel" style=" float:right;"></a>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
		...
		<th scope="col" id="mb_list_grp"><?php echo subject_sort_link('price', '', 'desc') ?>금액</a></th>
    </tr>
    </thead>
    <tbody>
    <?php
