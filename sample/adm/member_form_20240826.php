...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
		...
		<td>
		<?php echo get_member_level_select('mb_level', 1, $member['mb_level'], $mb['mb_level']) ?> 일반/상담사 
		...
		?>
			<a href="../bbs/write.php?w=<?=$w?>&bo_table=counselor<?=$purl?>" class="btn btn_01" target="_blank">상담사 프로필</a>
		<?
		}
		?>
		</td>
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tbody>
	 ...
	 <tr>
        <th scope="row"><label for="mb_no">상담사 번호<strong class="sound_only">필수</strong></label></th>
        <td><input type="text" name="mb_no" value="<?php echo $mb['mb_no'] ?>" id="mb_no"  class="frm_input" size="15" ></td>

          <th scope="row"><label for="mb_1">엠투넷 번호<strong class="sound_only">필수</strong></label></th>
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tbody>
    <tr>
        <th scope="row"><label for="mb_id">성별</label></th>
        <td colspan="3">
            <input type="radio" name="mb_10" value="남자"<?php echo ($member['mb_10'] == "남자") ? " checked" : "";?>> 남자
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="mb_10" value="여자"<?php echo ($member['mb_10'] == "여자") ? " checked" : "";?>> 여자
        </td>
    </tr>
    <tr>
        <th scope="row"><label for="mb_birth">생년월일</label></th>
        <td>
        	<input type="text" name="mb_birth" value="<?php echo isset($member['mb_birth'])?$member['mb_birth']:''; ?>" id="mb_birth" required class="frm_input" size="15" maxlength="50" placeholder="1988-06-22">
            
        </td>
        <th scope="row"><label for="mb_time">태어난시간<strong class="sound_only">필수</strong></label></th>
        <td><input type="text" name="mb_time" value="<?php echo isset($member['mb_time'])?$member['mb_time']:''; ?>" id="mb_time" required class="frm_input " size="15" maxlength="50" placeholder="오후3시"></td>
    </tr>
