...
<?php //echo help("커뮤니티에 표시될 것인지 쇼핑몰에 표시될 것인지를 설정합니다."); ?>
            <select name="nw_division" id="nw_division" style="display:none;">
                <option selected="selected" value="comm"<?php echo get_selected($nw['nw_division'], 'comm'); ?>>커뮤니티</option>
...
<?php //echo help("팝업레이어가 표시될 접속기기를 설정합니다."); ?>
            <select name="nw_device" id="nw_device" style="display:none;">
                <option selected="selected" value="both"<?php echo get_selected($nw['nw_device'], 'both', true); ?>>PC와 모바일</option>
...
<!--팝업레이어 좌측 위치-->
<input type="hidden" name="nw_left" value="<?php echo $nw['nw_left']; ?>" id="nw_left" required class="frm_input 
required" size="5">

<!--팝업레이어 상단 위치-->
<input type="hidden" name="nw_top" value="<?php echo $nw['nw_top']; ?>" id="nw_top" required class="frm_input required"  size="5">

<!--팝업레이어 넓이-->
<input type="hidden" name="nw_width" value="<?php echo $nw['nw_width'] ?>" id="nw_width" required class="frm_input required" size="5">

<!--팝업레이어 높이-->
<input type="hidden" name="nw_height" value="<?php echo $nw['nw_height'] ?>" id="nw_height" required class="frm_input required" size="5">
