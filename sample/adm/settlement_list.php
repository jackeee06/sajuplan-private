...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
		...
		<th scope="col">무료R%</th>
		<th scope="col">유료R%</th>
		<th scope="col">무료정산비</th>
		<th scope="col">유료정산비</th>
		<th scope="col" style="font-size:12px;">기타정산비</th>
		<th scope="col">정산비전체</th>
		<th scope="col">부가세공제</th>
		<th scope="col">원천세공제</th>
		<th scope="col">회선비</th>
		<th scope="col" id="mb_list_grp"><?php echo subject_sort_link('price', '', 'desc') ?>총정산금액</a></th>
    </tr>
    </thead>
    <tbody>
    <?php
    ...
    <tr class="<?php echo $bg; ?>">
		...
		<td class="td_mng_l"><?=number_format((int)$row['price_free'])?></td>
		<td class="td_mng_l"><?=number_format((int)$row['price_paid'])?></td>
		<td class="td_mng_l"><?=number_format((int)$row['price_other'])?></td>
		<td class="td_mng_l"><?=number_format((int)$row['price_tot'])?></td>
		<td class="td_mng_l"><?=number_format((int)$row['vat_amount'])?></td>
		<td class="td_mng_l"><?=number_format((int)$row['withholding_tax'])?></td>
		<td class="td_mng_l"><?=number_format((int)$row['reply_fee'])?></td>
