...
<section id="anc_sitfrm_cate">
    ...
    <?php echo $pg_anchor; ?>
    <div class="local_desc02 local_desc" style=" background-color:#fff; border:3px solid #F00;">
        <p style="color:#F00; font-weight:600;">
        	기본분류: 부가서비스<span style="display:inline-block; padding:0px 10px;">/</span>
            2차분류: 부가서비스 종류<span style="display:inline-block; padding:0px 10px;">/</span>
            3차분류: 부가서비스>상담사 (반드시 2차 분류에 속해있는 상담사 선택)
...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
		 ...
		 <!--<tr>
            <th scope="row"><label for="it_1">상담사 ID</label></th>
            <td colspan="2">
                <input type="text" name="it_1" value="<?php echo $it['it_1']; ?>" id="it_1" required class="frm_input" size="30"> <span style="font-weight:bold;">(상담사 소유상품일 경우 해당상담사 아이디 입력)</span>
            </td>
        </tr>-->
