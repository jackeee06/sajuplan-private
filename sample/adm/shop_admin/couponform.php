...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tbody>
    <tr>
        <th scope="row"><label for="cp_subject">등록일시</label></th>
        <td>
           <?=$cp["cp_datetime"]?$cp["cp_datetime"]:date("Y-m-d H:i:s",time());?>
        </td>
    </tr>
    ...
    <!-- 
    이걸 우선 textarea 로 바꿔야할드샇ㅁ.
    -->
    <tr>
        <th scope="row"><label for="mb_id">회원아이디</label></th>
        <td>
            <input type="text" name="mb_id" value="<?php echo stripslashes($cp['mb_id']); ?>" id="mb_id" class="frm_input" style="width:418px;">
