...
<div class="local_ov01 local_ov">
    ...
    <a href="?sst=mb_intercept_date&amp;sod=desc&amp;sfl=<?php echo $sfl ?>&amp;stx=<?php echo $stx ?>" class="btn_ov01"> <span class="ov_txt02">카드</span><span class="ov_num"><?php echo number_format($intercept_count) ?>건</span></a>
    <a href="?sst=mb_leave_date&amp;sod=desc&amp;sfl=<?php echo $sfl ?>&amp;stx=<?php echo $stx ?>" class="btn_ov01" > <span class="ov_txt02">가상결제</span><span class="ov_num"><?php echo number_format($leave_count) ?>건</span></a>
    <a href="?sst=mb_leave_date&amp;sod=desc&amp;sfl=<?php echo $sfl ?>&amp;stx=<?php echo $stx ?>" class="btn_ov01" > <span class="ov_txt02">이벤트</span><span class="ov_num"><?php echo number_format($leave_count) ?>건</span></a>
    <a href="?sst=mb_leave_date&amp;sod=desc&amp;sfl=<?php echo $sfl ?>&amp;stx=<?php echo $stx ?>" class="btn_ov01" > <span class="ov_txt02">쿠폰</span><span class="ov_num"><?php echo number_format($leave_count) ?>건</span></a>
    <a href="?sst=mb_leave_date&amp;sod=desc&amp;sfl=<?php echo $sfl ?>&amp;stx=<?php echo $stx ?>" class="btn_ov01" > <span class="ov_txt02">후기(손글씨)</span><span class="ov_num"><?php echo number_format($leave_count) ?>건</span></a>
    <a href="?sst=mb_leave_date&amp;sod=desc&amp;sfl=<?php echo $sfl ?>&amp;stx=<?php echo $stx ?>" class="btn_ov01" > <span class="ov_txt02">베스트후기</span><span class="ov_num"><?php echo number_format($leave_count) ?>건</span></a>
    <a href="?sst=mb_leave_date&amp;sod=desc&amp;sfl=<?php echo $sfl ?>&amp;stx=<?php echo $stx ?>" class="btn_ov01" > <span class="ov_txt02">VIP리워드</span><span class="ov_num"><?php echo number_format($leave_count) ?>건</span></a>
    <a href="?sst=mb_leave_date&amp;sod=desc&amp;sfl=<?php echo $sfl ?>&amp;stx=<?php echo $stx ?>" class="btn_ov01" > <span class="ov_txt02">관리자(지급)</span><span class="ov_num"><?php echo number_format($leave_count) ?>건</span></a>
    <a href="?sst=mb_leave_date&amp;sod=desc&amp;sfl=<?php echo $sfl ?>&amp;stx=<?php echo $stx ?>" class="btn_ov01" > <span class="ov_txt02">사용자(지급)</span><span class="ov_num"><?php echo number_format($leave_count) ?>건</span></a>
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tbody>
    <tr>
        <td scope="col" id="mb_list_chk" >1</td>
        <td scope="col" id="mb_list_id"><?php echo $row['po_datetime'] ?></td>        
        <td scope="col" id="mb_list_autd">상담료</td>  
        <td scope="col" id="mb_list_autd">상담사</td> 
        <td scope="col" id="mb_list_autd">C0000170</td>
        <td scope="col" id="mb_list_mng">hwa1497@naver.com</td>
        <td scope="col" id="mb_list_mng">별하</td>
        <td scope="col" id="mb_list_mng">010-7323-1497</td>
        <td scope="col" id="mb_list_mng">0</td>
        <td scope="col" id="mb_list_mng">5,200</td>
    </tr>
    </tbody>
    </table>
</div>
