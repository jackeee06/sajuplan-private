...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" id="mb_list_id"><?php echo subject_sort_link('mb_id', '', 'desc') ?>회원ID</th>
		...
		<th scope="col" id="mb_list_auth"><?php echo subject_sort_link('mb_1', '', 'desc') ?>mnet번호</th>
    ...
    <tr class="<?php echo $bg; ?>">
		...
		?>
			<a href="./member_form1.php?sst=&sod=&sfl=&stx=&page=&w=u&mb_id=<?=$row["mb_id"]?>"  target="_blank" class="btn btn_03" style="min-width:85px;">상담사 정보</a>			
		</td>
    </tr>
