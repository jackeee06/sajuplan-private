...
// 추천 멤버 추출
$sql_common = " from {$g5['member_table']} where mb_rising >= 1 and mb_rising <=  20  and state != 'ABSE' ";

$sql_order = " order by IF(state IN ('IDLE', 'CONN','RDVC', 'ABSE'), 0, 1), FIELD (state, 'IDLE','RDVC', 'CONN', 'ABSE',''), mb_rising asc ";
...
?>
    ...
    <ul id="" class="">
        ...
        <?php } ?>
        <?php if ($i == 0) echo "<li class=\"empty_list\">급상승 상담사가 없습니다.</li>"; ?>
    </ul>
