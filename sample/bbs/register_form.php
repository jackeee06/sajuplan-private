...
// 소셜 로그인 세션 플래그 확인
$is_social_login_new = get_session('ss_social_login');
...
if ($w == "") {
    ...
    if ($is_member && !$is_social_login_new) {
        goto_url(G5_URL);
    }
...
////home/thesaju7/www/theme/basic/mobile/skin/member/basic/register_form.skin.php

// if($_SERVER['REMOTE_ADDR'] == '115.93.39.5'){
//    echo $member_skin_path.'/register_form.skin.php';
// }
