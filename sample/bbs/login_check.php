...
// if ($is_social_login && (!$mb || !$mb['mb_id'])) {
//     set_session('ss_social_login', true);
//     goto_url(G5_PLUGIN_URL.'/social/register_member.php');
// }
...
if($member['mb_level'] == '5'){ // 상담사(권한5)일때
  goto_url('../shop/mypage.php');
}else{ //위 경우의 수가 아닐경우
  goto_url($link);
}