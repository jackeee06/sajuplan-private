        ...
        <li class="register_menu">
            ...
            <details>
            	...
            	<summary>
 				...
 				<ul>
                    <textarea readonly>'사주플랜'는 개인정보 보호법 제30조에 따라 정보주체(고객)의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립 · 공개합니다.
1. 개인정보의 처리목적
'사주플랜'는 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.
- 회원가입
- 게시판: 질문과 답변
...
2. 개인정보의 처리 및 보유기간
1 '사주플랜'는 정보주체로부터 개인정보를 수집할 때 동의받은 개인정보 보유 · 이용기간 또는 법령에 따른 개인정보 보유 · 이용기간 내에서 개인정보를 처리 · 보유합니다.
2 구체적인 개인정보 처리 및 보유 기간은 다음과 같습니다.
- 소비자의 불만 및 분쟁처리에 관한 기록 : 3년
- 로그기록 : 3개월

3. 개인정보의 제3자 제공
'사주플랜'는 정보주체의 별도 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조에 해당하는 경우 외에는 개인정보를 제3자에게 제공하지 않습니다.

4. 개인정보처리의 위탁
1 '사주플랜'는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 외부에 위탁하고 있습니다.
