                ...
                <div class="mb_20 chat_temp">
                    <div class="flex align-items-start bubble_right gap_10">
                        <div class="chat-speech outgoing_msg_img">
                            ...
                            <div class="mb_10">
                                <div class="speech_bubble speech_bubble_right msg" data-toggle="modal" data-target="#request_flor_btn">    <?php
                                    if ($is_html) {
                                        echo $msg; // 이미지 HTML 그대로 출력
                                    } else {
                                        echo nl2br($msg); // 일반 텍스트 출력 (줄바꿈 포함)
    ...
    <div class="modal-box">
                        ...
                        <li><a href="<?= $profile_url ?>">
                                ...
                                <div class="counselor_s_info">
                                    <div class="top"><span
                                        ...
                                        <p><?= $row['mb_nick'] ?></p></div>
                                    <div class="bottom"><p>
                                            <!--                                        <span>--><?php //= number_format($row['mb_4']) ?><!--원</span> --><?php //= $row['mb_5'] ?><!--초당</p><span-->
                                            <span><?= number_format($row['mb_13']) ?>원</span> <?= $row['mb_12'] ?>초당</p><span
                                                class="g-line"></span>
        ...
        <?php if ($member['mb_level'] != 5){ ?>
            ...
            <div class="modal-footer">
                ...
                <button class="color-btn" onclick="location.href='../bbs/write.php?bo_table=review&csr_id=<?=$csr_row["mb_id"]?>&cno=<?=$csr_row["no"]?>' ">후기작성</button>
            </div>
        <?php }else { ?>
            <div class="modal-footer">
                <button onclick="location.href='../my/chat_record.php' ">종료</button>
