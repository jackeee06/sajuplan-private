...
define('MOTONET_CALL_KEY', 'f58cdy2sXhkOdp2YSJUjuqEJB');
define('MOTONET_CPID', '0047');
...
$tel_070 = "070-8016-9699";
$tel_060 = "060-500-0878";

$CPID = "0047";// CP ID
$headerKey = "f58cdy2sXhkOdp2YSJUjuqEJB";//CP 사키

$cate_bg = array('타로'=>'tarot','신점'=>'sinjeom','사주'=>'saju','심리'=>'simli');


//20250731 eun RDVC 추가 시작
$s_state = array("IDLE"=>"전화상담가능","ABSE"=>"부재중","CONN"=>"전화상담중","RESV"=>"예약","CRDY"=>"상담준비","RDVC"=>"전화채팅가능","RDCH"=>"채팅상담가능","CNCH"=>"채팅상담중");
//20250731 eun RDVC 추가 마감

$s_wr_5_array = array("운세", "속마음", "연애", "짝사랑", "재회", "궁합", "금전", "건강", "취업", "합격", "사업", "택일", "이사", "작명/개명", "불륜/이혼", "삼재", "고민", "꿈해몽");


$bankName =  array("기업은행"=>"BK03", "국민은행"=>"BK04", "우리은행"=>"BK20", "수협"=>"BK07", "농협"=>"BK11", "부산은행"=>"BK32", "SC제일은행"=>"BK23", "신한은행"=>"BK26", "KEB하나은행"=>"BK81", "광주은행"=>"BK34", "우체국"=>"BK71", "대구은행"=>"BK31", "경남은행"=>"BK39");

///////////////////// 신용카드 암호화관련 /////////
$crypt_pass = "pGXygBXTMNNuRJzC"; // 16자리
$crypt_iv = $crypt_pass;
$crypt_pass = hash("sha512",$crypt_pass);
//////////////////// 신용카드 암호화 관련 끝 ///////////
/// 20250826 eun 알리고 문자서비스 시작
// ex) /config.php 또는 _common.php 보다 먼저 로딩되는 환경 파일
define('ALIGO_USER_ID',   '');
define('ALIGO_KEY',       '');
define('ALIGO_SENDER',    ''); // 사전등록 발신번호(숫자만)
/// 20250826 eun 알리고 문자서비스 마감
