...
<html lang="ko">
  ...
  <body>
    ...
    />
    <div class="container">
      <h3 class="text-center">AG9상담톡</h3>
    ...
    <script>
      ...
      function SendMsg2ServerSubmit() {
        const input = document.querySelector('textarea[type="text"]');
        const tpMsg = input.value;
        const svrData = {
          CmdTp: "conv_msg",
          Msg: tpMsg,
          HtmlFlag: false,
