                        ...
                        <div class="divTableRow coin_fill_item">
                            <div class="divTableCell coin_fill_name event">
                                <input type="radio"
                                       ...
                                       value="<?=$t['pay_amount']?>"
                                    <?=$i===2?'checked':''?>   onclick="disp_btn_amount('<?=number_format($t['price'])?>');" />      <!-- 3번째 기본 선택 -->

                                <label for="coinChk<?=$t['product_id']?>">
                                    <!-- 화면 표시: VAT 별도 금액 -->
                                    <?=number_format($t['price'])?> <span class="f_500"> ⓟ</span>
                                    <p class="coin_fill_bonus">
                                        + <?=$t['bonus_percent']?><span>%</span>
                                        <span class="coin_fill_text"><?=$t['message']?></span>
                                    </p>
                                    <!-- 총 지급 포인트 -->
                                    <p class="coin_fill_price_pay"><?=number_format($t['total_point'])?><span class="f_500"> ⓟ</span></p>
                                    <?php if(!empty($t['message'])): ?>
                                        <!--                                <p class="coin_fill_msg">--><?php //=$t['message']?><!--</p>-->
                                    <?php endif; ?>
                                </label>
                            </div>
                        </div>
