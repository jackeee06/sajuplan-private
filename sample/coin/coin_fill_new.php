...
<script language="javascript"> 
	...
	function on_pay(str) {
		...
		url = "https://passcall.co.kr:32837/cptl/gnrc-pc/payr";
		if (Mobile()){// 모바일일 경우
			url = "https://passcall.co.kr:32837/cptl/gnrc-mob/payr1";
		} 

		if(str=="CARD"){
			
		}else if (str == "VBANK") {
			url = "https://passcall.co.kr:32837/cptl/gnrc-vrbank/payr";
		}else if(str=="APPLE"){
...
//			}
	...
	function pay_go(){
		...
		on_pay(paymethod);
        try{
            g4_begin_checkout_new(price, orderNo, '충전하기');
        }catch (e) {
            console.log(e);
        }
		g4_begin_checkout(price, orderNo, '충전하기');
    ...
    <div class="search_box">
        ...
        <div class="check">
            <ul>
                ...
                <li>
                    <div>
                        <input type="radio" id="chk2" name="echk" value="2" style="margin-right: 5px; margin-bottom: 3px;" checked />
