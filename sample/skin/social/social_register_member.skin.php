    ...
    <form name="fregisterform" id="fregisterform" action="<?php echo $register_action_url; ?>" onsubmit="return fregisterform_submit(this);" method="POST" autocomplete="off">
        ...
        <section id="fregister_term">
            ...
            <fieldset class="fregister_agree">
                ...
                <label for="agree11"><span></span><b class="sound_only">회원가입 약관의 내용에 동의합니다.</b></label>
            </fieldset>
        </section>
            ...
            <div class="tbl_frm01 tbl_wrap register_form_inner">
                ...
                <ul>
                    ...
                    <?php if ($req_nick) {  ?>
                        <li>
                            <label for="reg_mb_nick">
                                ...
                                <span class="tooltip">공백없이 한글,영문,숫자만 입력 가능 (한글2자, 영문4자 이상)<br> 닉네임을 바꾸시면 앞으로 <?php echo (int)$config['cf_nick_modify'] ?>일 이내에는 변경할 수 없습니다.</span>
                            </label>
                    ...
                    <li style="display:none;">
                        ...
                        <input type="text" name="mb_email" value="<?php echo isset($user_email) ? $user_email : ''; ?>" id="reg_mb_email" <?php echo (isset($user_email) && $user_email != '' && !$is_exists_email)? "readonly":''; ?> class="frm_input email full_input" size="70" maxlength="100" placeholder="E-mail">
