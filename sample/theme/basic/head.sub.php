...
?>
    ...
    <head>
        ...
        <?php
          add_javascript('<script src="' . G5_JS_URL . '/platform.js?ver=' . G5_JS_VER . '"></script>', 0);
        ?>
...
<![endif]-->
        ...
        <?
        if ($member["mb_id"]) {
            $ios_mb_id = $member["mb_id"];
            $ios_mb_hp = $member["mb_hp"];
            ?>
            <script>
                var ios_mb_id = "<?=$ios_mb_id?>";
                ...
                try {
                    ...
                    window.webkit.messageHandlers.get_fcm_token.postMessage(ios_mb_id);
        ...
        <link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL; ?>/mobile.css?ver=<?= G5_CSS_VER ?>">
...
<style>
    ...
    /*
    #hd_wrapper { width:100%; position:sticky; top:0;} 20250825
    */
