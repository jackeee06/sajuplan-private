...
<header id="hd">
	...
	<div class="top_banner">
    	...
    	<div id="topBanner" style="display: block;">
        <div class="bn_con">
        	<a href="../bbs/board.php?bo_table=wish">
            <ul style="width:100%; float:left;  position:relative;">
                <p style="position:relative; z-index:1; padding:10px 30% 10px 20px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; font-size:14px; color:#fff; line-height:22px;">특별히 좋은 일이나 새로운 사건이 없어도 지금처럼 무난하게 흘러가게 해주세요.</p>
                <p style="position:absolute; top:0; right:0; z-index:0;"><img src="../../../img/head/top_bg.png" style=" height:42px; width:auto;" /></p>
</ul>
            </a>
        </div>
        <div class="bn_close">
    ...
    <div id="hd_wrapper">
		...
		<h2 id="container_title" class="top" title="<?php echo get_text($g5['title']); ?>">
			...
			<img src="<?php echo G5_IMG_URL ?>/common/logo.png" style=" height:40px; width: auto; margin-top:-6px;"/>
            </a>
