...
-->
    ...
    <style>
        ...
        /*20250805 eun 메인 상담  건수, 상담사 폰트 크기 12 -> 15 확대 시작*/
        .main_state .main_state_name {font-size:15px; color:#000; font-weight:500;}
        /*20250805 eun 메인 상담  건수, 상담사 폰트 크기 확대 마감*/
        .main_state .main_state_name p {display:block; font-weight:500;}
        /*20250805 eun 메인 상담  건수, 상담사 폰트 크기 15 -> 17 확대 시작*/
        .main_state .main_state_name .conuter span{font-size:17px; font-weight:700; color:#E84263;}
        ...
        <?php if ((count($recent_list) > 0) and $member['mb_id'] and  $member['mb_level'] != 10) { ?>
            ...
            <script>
                ...
                function reloadRecentCounselors() {
                    $.ajax({
                        url: '/sub/recent_counselor_ajax.php', // 실제 경로로 수정
                        type: 'GET',
...
<!--            2025-->
            <label for="tab02" style="font-size: 16px;">급상승 <span class="hot_new">HOT</span></label>
            ...
            <label for="tab06" style="font-size: 16px;">후기 <span class="hot_new">NEW</span></label>
        </div>
       ...
       <!-- <script>
        ...
        <script>
            ...
            setInterval(function() {
                pollStatesAndUpdate("tab2-list-area", "/sub/main_tab2.php", {'act': 'rising'}, false);
            }, 15000);
            ...
            $("#tab5-refresh-btn").on("click", function() {
                pollStatesAndUpdate("tab2-list-area", "/sub/main_tab2.php", {'act': 'rising'}, true);
            });
        ...
        <script>
            ...
            // 자동 polling(주기적 업데이트)에서는 showIndicator를 false로 해도 됩니다.
            setInterval(function() {
                pollStatesAndUpdate("tab3-list-area", "/sub/main_tab3.php", {'act': 'sco'}, false);
            }, 15000);
            ...
            // 새로고침 버튼(예시) - indicator O
            $("#tab5-refresh-btn").on("click", function() {
                pollStatesAndUpdate("tab3-list-area", "/sub/main_tab3.php", {'act': 'sco'}, true);
            });
        </script>
        ...
        <script>
            ...
            // 자동 polling(주기적 업데이트)에서는 showIndicator를 false로 해도 됩니다.
            setInterval(function() {
                pollStatesAndUpdate("tab4-list-area", "/sub/main_tab4.php", {'act': 'rdvc'}, false);
            }, 15000);
            ...
            $("#tab4-refresh-btn").on("click", function() {
                pollStatesAndUpdate("tab4-list-area", "/sub/main_tab4.php", {'act': 'rdvc'}, true);
            });
        ...
        <script>
            ...
            // 자동 polling(주기적 업데이트)에서는 showIndicator를 false로 해도 됩니다.
            setInterval(function() {
                pollStatesAndUpdate("tab5-list-area", "/sub/main_tab5.php", {'act': 'all'}, false);
            }, 15000);
            ...
            // 새로고침 버튼(예시) - indicator O
            $("#tab5-refresh-btn").on("click", function() {
                pollStatesAndUpdate("tab5-list-area", "/sub/main_tab5.php", {'act': 'all'}, true);
            });
        </script>
        <!-- 후기 06-->
        <div class="conbox con6">
            ...
            while ($row = sql_fetch_array($result)) {
               ...
               /* $consult_info = '';
                ...
                if (!empty($row['wr_10'])) {
                    // 단일 행이면 sql_fetch가 간단
                    $no = sql_real_escape_string($row['wr_10']);
                    ...
                    } elseif (!empty($row['wr_2'])) { // usetm 없으면 wr_2 사용
                        $consult_info = $row['wr_2'];
                    }
                } elseif (!empty($row['wr_2'])) {
                    // wr_10 자체가 없을 때 wr_2 사용
                    $consult_info = $row['wr_2'];
                }
                ...
                <div class="review_wrap">
                    ...
                    <ul class="review_user">
                        ...
                        <li class="review_user_score">
                            <span class="review_info"><?=var_dump($crow)?>상담</span>
                            <span class="review_info">row상담<?=var_dump($row)?></span>
                            <span class="review_info">consultinfo상담<?=var_dump($consult_info)?></span>
                            <span class="review_info">sql<?=var_dump($sql)?></span>
                            <span class="review_info">result<?=var_dump($result)?></span>
