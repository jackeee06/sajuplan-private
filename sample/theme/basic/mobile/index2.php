...
.main_navi .main_navi_item {border:1px solid #eee; border-radius:80px 80px 80px 80px; padding:18px 0px; text-align:center; width:calc(20% - 10px); max-width:100px;}
.main_navi .main_navi_item img {width:calc(100% - 10px); max-width: 60px;}
...
//}, 2000)
    ...
    <div class="conbox con3">
		...
		<div class="counselor_tap_title">더사주에 새롭게 모셔온 상담사</div>        
    ...
    <div class="conbox con4">
		...
		<div class="counselor_tap_title">현재 상담 가능한 전체 상담사</div>
...
<div class="counselor_list_wrap" >
  ...
  <h2 style=" width:100%; float:left; font-size:20px; font-weight:600; padding:20px 20px 0;"><!--<span class="point"><?=$member["mb_name"]?></span>님을 위한 -->더사주 AI 상담사 추천!</h2>
...
<div class="main_footer">
    ...
    <div class="main_footer_copy">Copyrightⓒ 더사주. All Rights Reserved.</div>
</div>
