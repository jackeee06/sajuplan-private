...
<div id="container" class="<?php echo implode(' ', $container_class); ?>">
    ...
    <h1 id="container_title" style="display:none;">
    	<a href="javascript:history.back()" class="btn_back"><i class="fa fa-chevron-left" aria-hidden="true"></i><span class="sound_only">뒤로</span></a>
