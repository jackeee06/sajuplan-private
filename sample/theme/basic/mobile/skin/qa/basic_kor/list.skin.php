...
<div id="bo_list">
    ...
    <div class="all_chk chk_box">
        ...
        <button type="submit" name="btn_submit" value="선택삭제" onclick="document.pressed=this.value"><i class="fa fa-trash-o" aria-hidden="true"></i> 선택삭제</button>
...
<ul class="btn_top top btn_bo_user">
	...
	<?php } ?>
	<?php if ($write_href) { ?><li style="display:none;"><a href="<?php echo $write_href ?>" class="fix_btn"><i class="fa fa-pencil" aria-hidden="true"></i><span class="sound_only">문의등록</span></a></li><?php } ?>
</ul>
<?php } ?>
-->
    ...
    <div class="list_01">
        <ul>
            ...
            <li class="bo_li<?php if ($is_checkbox) echo ' bo_adm'; ?>">
                ...
                <div class="li_info">
                	<?php if ($is_checkbox) { ?>
		                <div class="bo_chk chk_box" style=" width: auto;">
                ...
                <div class="bo_cnt">
                    <p class="bo_subject">
                        ...
                        <span class="qa_status <?php echo ($list[$i]['qa_status'] ? 'txt_done' : 'txt_rdy'); ?>">
						<?php echo ($list[$i]['qa_status'] ? '완료' : '대기'); ?>
                    </span>
                    </p>
...
<!--
<?php if ($write_href) { ?>
	<div class="qa_btn_wrap">
    	<a href="<?php echo $write_href ?>" class="fix_btn"><i class="fa fa-pencil" aria-hidden="true"></i><span class="sound_only">문의하기</span></a>
    </div>
<?php } ?>
-->
...
<?php if ($write_href) { ?>
	<div class="fix_btn write_btn ">
    	<a href="<?php echo $write_href ?>" class="point_bg white" title="작성">문의하기</a>
    </div>
<?php } ?>   
...
<fieldset id="bo_sch">
    ...
    <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required placeholder="키워드를 입력하세요" id="stx" class="sch_input" size="15" maxlength="15">
