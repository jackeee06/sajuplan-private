...
<section id="bo_v_ans">
    ...
    <div class="form_01">
        <ul>
            ...
            <li class="icon">
                ...
                <input type="text" name="qa_subject" value="" id="qa_subject" required class="frm_input full_input required" size="" maxlength="255" placeholder="제목">
            </li>
            <li class="icon">
    ...
    <div class="btn_confirm" style="position:fixed; left:0; bottom:0; width:100%; margin:0;">
        <input type="submit" value="답변쓰기" id="btn_submit" accesskey="s" class="btn_submit" style="width:100%; border-radius:0; height:55px; font-size:18px;">
    </div>
    </form>
    ...
    {
    ?>
    <p id="ans_msg">귀하의 문의에 대한 답변을 준비하고 있습니다.</p>
    <?php
    }
    ?>
</section>