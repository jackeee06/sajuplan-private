...
<div style="background-color:#f5f5f5; padding:20px;">
	...
	"자주하는 질문"에서 확인 후 문의하시기 바랍니다.
    <a href="../bbs/board.php?bo_table=c_faq">
    <div>자주하는 질문 바로가기</div>
    </a>
...
<?php if ($write_href) { ?>
	<div class="bottom_btn">
    	<a href="<?php echo $write_href ?>" class="btn_100">
        	문의등록
        </a>
    </div>
<?php } ?>
        ...
        <ul>
            ...
            <li class="bo_li<?php if ($is_checkbox) echo ' bo_adm'; ?>">
                ...
                <div class="li_info">
                	...
                	<span class="<?php echo ($list[$i]['qa_status'] ? 'txt_done' : 'txt_rdy'); ?>">
