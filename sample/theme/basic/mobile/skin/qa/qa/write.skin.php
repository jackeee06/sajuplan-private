...
<section id="bo_w">
    ...
    <div class="form_01">
        <ul>
            ...
            <?php if (!$is_admin) { ?>
            <li class="bo_w_flie icon">            
            	
                <label for="qa_content">첨부파일<strong>필수</strong></label>
                <div class="file_wr filebox">
                	<p><i class="xi-upload"></i></p>
                	<input type="text" class="fileName" readonly="readonly" placeholder="파일을 첨부하세요">
                    <label for="bf_file[1]"><i class="fa fa-download lb_icon" aria-hidden="true"></i><span>파일 #1</span><span class="btn_file">파일첨부</span></label>
                ...
                <div class="file_wr filebox">
                	<p><i class="xi-upload"></i></p>
                	<input type="text" class="fileName" readonly="readonly" placeholder="파일을 첨부하세요">
                    <label for="bf_file[2]"><i class="fa fa-download lb_icon" aria-hidden="true"></i><span>파일 #2</span><span class="btn_file">파일첨부</span></label>
