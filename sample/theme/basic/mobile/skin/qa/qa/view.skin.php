...
<article id="bo_v">
    <header>
        <h2 id="bo_v_title">            
            ...
            <span class="bo_v_date"><?php echo $view['datetime']; ?></span>
        </h2>
    </header>
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_contact">
            <h2>연락처정보</h2>
            <dl>
            	<dt><i class="fa fa-user-o" aria-hidden="true"></i><span class="sound_only">작성자</span></dt>
        ...
        <?php if ($update_hre0f || $delete_href) { ?>
        <div class="edit_btns" style="position:relative; padding:15px 0 0 0;">
        	<?php if ($update_href) { ?>
            	<a href="<?php echo $update_href ?>" charset="btn_modify">
                	<i class="fa fa-pencil-square-o" aria-hidden="true"></i> 수정
                </a>
			<?php } ?>
            
        	<?php if ($delete_href) { ?>
                <a href="<?php echo $delete_href ?>" onclick="del(this.href); return false;" class="btn_del">
