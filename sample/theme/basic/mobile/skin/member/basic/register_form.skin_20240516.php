...
<div class="register">
    ...
    <div class="form_01">
        <ul>
	        <li class="icon">
            	<p><i class="xi-user-o" aria-hidden="true"></i></p>
	            <label for="reg_mb_id" class="sound_only">아이디<strong>필수</strong></label>
	            <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" class="frm_input full_input <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20" <?php echo $required ?> <?php echo $readonly ?> placeholder="아이디(영문자, 숫자, _ 만 입력 가능. 최소 3자이상)">
	            <span id="msg_mb_id"></span>
	            <!--<span class="frm_info">영문자, 숫자, _ 만 입력 가능. 최소 3자이상 입력하세요.</span>-->
	        </li>
	        <li class="icon">
            	<p><i class="xi-lock-o" aria-hidden="true"></i></p>                
	        ...
	        <li class="rgs_name_li icon">
            	<p><i class="xi-profile-o" aria-hidden="true"></i></p>
			...
			<li class="icon">
            	<p><i class="xi-at" aria-hidden="true"></i></p>
	        ...
	        <li class="icon">
            	<p><i class="xi-mobile" aria-hidden="true"></i></p>
            ...
            <li class="icon chk_box agree">
            	<p><i class="xi-paper-o"></i></p>
                
            	<fieldset>
		        	<input type="checkbox" name="agree" value="1" id="agree11" class="selec_chk">
		            <label for="agree11">
	    	        	<span></span>
	        	    	<b class="sound_only">회원가입약관 동의</b>
                	    
		            </label>            
                    <a  href="#layer2" charset="btn-pop"><span class="chk_li">회원가입약관에 동의합니다.</span></a>
                </fieldset>
			...
			<li class="icon chk_box agree">
                ...
                <fieldset>
		            ...
		            <label for="agree21">
	    	        	<span></span>
	        	    	<b class="sound_only">개인정보처리방침 동의</b>
                	    
		            </label>
	            	<span class="chk_li">개인정보처리방침안내에 동의합니다</span>
...
<div class="dim-layer">
    ...
    <div id="layer2" class="pop-layer">
        <div class="pop-container">
            ...
            <div class="btn-r">
                <a href="#" class="btn-layerClose"><i class="xi-close-thin"></i></a>
            </div>
    </div>
</div>