...
<div id="reg_result">
    ...
    <div class="reg_result_wr">
        <p class="reg_cong center">
            <strong><?php echo get_text($mb['mb_name']); ?></strong>님, 반가워요 👋<br>
            신규 회원 누구나 받을 수 있는 혜택!<br />
        </p>
    ...
    <?php echo display_banner('회원가입완료', 'mainbanner.10.skin.php'); ?>
