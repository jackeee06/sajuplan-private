...
<div class="lt owl-carousel-wrap">
    <a href="<?php echo get_pretty_url($bo_table); ?>" class="lt_title"><strong><?php //echo $bo_subject; ?>뉴스기사</strong></a>
    <div class="<?php echo $list_count ? 'latest-sel' : ''; ?>">
        <ul class="item">
            ...
            <div style="width:calc(100% - 80px);">
               ...
               <div class="lt_info" style="display:block;">
    ...
    <?php } ?>
    <a href="<?php echo get_pretty_url($bo_table); ?>" class="lt_more"><span class="sound_only"><?php echo $bo_subject ?></span>더보기 <i class="xi-angle-right"></i></a>
</div>