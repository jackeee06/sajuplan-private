...
<div class="con_section_03" >
	...
	<div class="review_top">
        ...
        <ul class="review_top_noti">
        	<i class="xi-check point"></i> 문의 시 전화번호, SNS 등의 개인정보를 남기시면 이용이 제한 될 수 있습니다.
        </ul>
    	
        <ul class="review_write_btn">
        	<a href="<?php echo $itemqa_form; ?>" class="itemqa_form qa_wr">문의 작성하기 <i class="xi-angle-right"></i></a>
        </ul>
    </div>
    
    <div class="review_wrap_title">
    	서비스 문의
        <a href="<?php echo $itemqa_list; ?>" id="itemuse_list" class="review_more">더보기 <i class="xi-angle-right"></i></a>
    </div>
...
<div id="sit_qa_wbtn" style="display:none;">
    <a href="<?php echo $itemqa_form; ?>" class="itemqa_form qa_wr">서비스문의 쓰기<span class="sound_only"> 새 창</span></a>
...
<div id="sit_qa_list">
    ...
    if (!$i) echo '<p class="sit_empty">서비스문의가 없습니다.</p>';
    ?>
</div>
