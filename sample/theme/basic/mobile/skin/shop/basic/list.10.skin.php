...
<style>
.sct_10 .sct_img .sct_partner { display:none;}
</style>

<h2 style="padding:20px 20px 0; font-size:20px;"><span class="point"><?php echo $member['mb_id'] ? $member['mb_nick'] : '비회원'; ?></span>님을 위한 추천</h2>
...
foreach((array) $list as $row){
   ...
   if($i % $this->list_mod == 0)
	...
	echo "<div class=\"sct_partner\">\n";
	echo "<span class=\"sct_partner_img\" style=\"background-image:url('../img/common/noimage_mem.png');\"></span> 상담사\n";
	echo "</div>\n";
	...
	echo "<div class=\"sct_info\">";

	if ($this->view_it_basic && $row['it_basic']) {
        echo "<a href=\"{$item_link_href}\"><div class=\"sct_basic\">".stripslashes($row['it_basic'])."</div></a>\n";
    }
    ...
    if ($this->view_it_price) {
        echo "<a href=\"{$item_link_href}\"><div class=\"sct_cost\">\n";
        echo display_price(get_price($row), $row['it_tel_inq'])."\n";
        echo "</div></a>\n";
    }
?>

<div class="sct_review">
	<img src="../../../img/common/icon_review.png">
    후기<span class="sct_review_count">(<?=get_item_use_cnt($row["it_id"])?>)</span>
</div>
...
<?php if ($member['mb_level'] == '5'){ //권한5: 상담사 ?>
	<?php
		if($i == 0) echo "<p class=\"sct_noitem\"><a href=\"../bbs/qalist.php\"><span style=\"display:inline-block; padding:10px 40px; background-color:#000; color:#fff; font-size:20px; border-radius: 6px; \">문의하기</span></p></a>\n";
