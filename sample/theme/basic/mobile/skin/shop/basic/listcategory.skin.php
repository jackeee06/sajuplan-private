...
if ($exists) {
	...
	//echo G5_SHOP_CSS_URL;
	//https://www.sajumoon.co.kr/theme/basic/mobile/skin/shop/basic/style.css
...
<aside id="sct_ct_1" class="sct_ct">
    ...
    <ul>
      	<li><a class="point on" href="../shop/list.php?ca_id=10">전체<span class="prd_cnt">000</span></a></li>    	
        <?php echo $str; ?>
    </ul>
</aside>
<!-- } 상품분류 1 끝 -->
