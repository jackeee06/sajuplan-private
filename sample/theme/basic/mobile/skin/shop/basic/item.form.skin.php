...
<div id="sit_ov_wrap">
    ...
    <section id="sit_ov" class="2017_renewal_itemform">
        <h2>상품간략정보 및 결제기능</h2>
        <div class="sit_ov_wr">
        	<p id="sit_cate" class="point"><?php echo $it['ca_name']; ?></p>
...
?>
            ...
            <!--<strong id="sit_title">상담사<?php //echo stripslashes($it['it_name']); ?></strong>-->
            ...
            <!-- 소개글 <?php if($it['it_basic']) { ?><p id="sit_desc"><?php echo $it['it_basic']; ?></p><?php } ?>-->
            <?php if($is_orderable) { ?>
            ...
            <div class="sit_ov_tbl" style="display:none;">
                <table >
                <colgroup>
                    <col class="grid_2">
                    <col>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if($it['it_point_type'] == 2) {
                            echo '결제금액(추가옵션 제외)의 '.$it['it_point'].'%';
                        } else {
...
<div class="btn_option_wr">
	<!--
    <ul class="btn_option_wish" style="">
        <a href="javascript:item_wish(document.fitem, '<?php echo $it['it_id']; ?>');" id="sit_btn_wish">
        	<img src="../img/common/list_icon_wish.png">
            <span class="sound_only">위시리스트</span>
        </a>  
    </ul>
    -->        
	<button type="button" class="btn_cart_op btn_submit btn">결제하기</button>
</div>
...
<div id="btn_option">
    <div class="sl_option">
        ...
        <?php if($is_soldout) { ?>
        <p id="sit_ov_soldout">상품의 재고가 부족하여 결제할 수 없습니다.</p>
        <?php } ?>
        <div id="sit_ov_btn">
            <?php if ($is_orderable) { ?>
            <input type="submit" onclick="document.pressed=this.value;" value="장바구니" id="sit_btn_cart">
            <input type="submit" onclick="document.pressed=this.value;" value="바로결제" id="sit_btn_buy" class="btn_submit">
            <?php } ?>
    ...
    <button type="button" class="btn_close"><span class="sound_only">닫기</span><i class="xi-close"></i></button>
</div>
...
<style>
#sit_info { padding:0 20px 20px; position:relative; display: flex; border-bottom:10px solid #f5f5f5;}
#sit_info .sit_info_item { font-size:14px; padding-right:10px; display: flex; align-items: center;}
#sit_info .sit_info_item .sit_info_count { color:#999;}
#sit_info .sit_info_item img { height:16px; margin-right:4px;}
</style>


<div id="sit_info">
	<ul class="sit_info_item"></ul>
	<ul class="sit_info_item">
    	<img src="../../../img/common/icon_review.png">
	    전체후기<span class="">(<?=get_item_use_cnt($it_id)?>)</span>
    </ul>
	<ul class="sit_info_item">
    	<img src="../../../img/common/icon_qna.png">
	    전체문의<span class="">(<?=get_item_qa_cnt($it_id)?>)</span>
    </ul>
</div>

<div id="sit_tab">
    <ul class="tab_tit">
        <li><button type="button" id="btn_sit_inf" rel="#sit_inf" class="selected">서비스 정보</button></li>
        <li><button type="button" id="btn_sit_use" rel="#sit_use">서비스 후기</button></li>
        <li><button type="button" id="btn_sit_qa" rel="#sit_qa">서비스 문의</button></li>
        <li><button type="button" id="btn_sit_dvex" rel="#sit_dvex">교환/반품/배송<!--서비스 전달--></button></li>
    </ul>
    <ul class="tab_con">
        ...
        <li id="sit_dvex">
            ...
            <div id="sit_dvr">
                <h3>배송정보</h3>
                <ul style="padding:20px;"><?php echo conv_content($default['de_baesong_content'], 1); ?></ul>
            </div>
            <!-- } 배송정보 끝 -->
            <?php } ?>
            ...
            <div id="sit_ex" >
                <h3>교환/반품</h3>
                <ul style="padding:20px;"><?php echo conv_content($default['de_change_content'], 1); ?></ul>
            </div>
            <!-- } 교환/반품 끝 -->
            <?php } ?>
        </li>
