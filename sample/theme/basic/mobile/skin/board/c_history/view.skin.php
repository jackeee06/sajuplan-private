...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        ...
        <div id="bo_v_info">
            ...
            <!--            20250806 eun 상담내역 rud 작업시작-->
            <div style="float:right; margin-top:-10px;">
                <? if ($_GET['c_url'] == 'chat') {?>
                    <!--            <a href="--><?php //echo $list_href ?><!--" class="btn black_bg white">목록보기</a>-->
                    <a href="../my/chat_record.php" class="btn black_bg white">목록보기</a>
                <? } else if ($_GET['c_url'] == 'call') { ?>
                    <a href="../my/counselor_history.php" class="btn black_bg white">목록보기</a>
                <? } else { ?>
<!--                    <a href="--><?php //echo $list_href ?><!--" class="btn black_bg white">목록보기</a>-->
<!--                    <a href="../my/counselor_history.php" class="btn black_bg white">목록보기</a>-->
                <? } ?>
                <!--            20250806 eun 상담내역 rud 작업마감-->
                <?php if ($update_href) { ?>
