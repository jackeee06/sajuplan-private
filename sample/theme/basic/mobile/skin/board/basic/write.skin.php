<?php
    ...
    //     var_dump($board_skin_path.'/write_update.skin.php');
    // }
...
<section id="bo_w">
    <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="form_01 write_div">
            ...
            ?>
                <div class="write_div">
                    <select name="gubun" id="gubun" style="display:block;width:100%;height:40px;padding:0 10px;font-size:14px;line-height:40px;color:#222;background:#fff;border:1px solid #ddd;border-radius:4px;">
