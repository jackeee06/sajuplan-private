    ...
    <div class="form_01 write_div">
        ...
        <div class="bo_w_flie write_div">
            <div class="file_wr write_div filebox">
            	<input type="text" class="fileName" readonly="readonly" placeholder="상담사 이미지를 입력해주세요.">
            ...
            <input type="text" name="bf_content[]" value="<?php echo ($w == 'u') ? $file[$i]['bf_content'] : ''; ?>" title="파일 설명을 입력해주세요." class="full_input frm_input" size="50" placeholder="상담사 이미지를 입력해주세요.">
            <?php } ?>
        ...
        <div class="bo_w_link write_div">
            ...
            <input type="text" name="wr_link<?php echo $i ?>" value="<?php if($w=="u"){echo $write['wr_link'.$i];} ?>" id="wr_link<?php echo $i ?>" class="frm_input wr_link" placeholder="선생님 소개 페이지 URL을 입력해주세요.">
        </div>
        <?php } ?>
