...
.type_check { display:inline-block; width:110px; margin-bottom:10px;}
    ...
    <div class="form_01 write_div">
        ...
        <div class="bo_w_tit write_div counselor_01">
            ...
            <ul class="item">
            	<div class="input_wrap required">
        		    ...
        		    <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input" placeholder="상담사 이름">
            	</div>
            </ul>
        </div>
        ...
        <div class="write_div counselor_01">
        	<ul class="subject">가격/시간</ul>
            <ul class="item">
            	<div class="input_wrap w50 required">
		            <label for="wr_1" class="sound_only">가격<strong>필수</strong></label>
        		    <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="frm_input full_input  right" maxlength="20" placeholder="가격" style="width:calc(100% - 20px);" />원
            	</div>
            
            	<div class="input_wrap w50 required">
		            <label for="wr_2" class="sound_only">시간기준<strong>필수</strong></label>
        		    <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="frm_input full_input  right" maxlength="20" placeholder="시간기준" style="width:calc(100% - 20px);" />초
            	</div>
            </ul>
        </div>
        
        <div class="write_div counselor_01">
        	<ul class="subject">해시태그</ul>
            <ul class="item">
            	<div class="input_wrap w50 required">
