...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <?php if($bo_table == 'column'){ // 칼럼 한줄소개 ?> 
        <div class="write_div">
            <label for="wr_1" class="sound_only">한줄소개</label>
            <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input full_input" placeholder="한줄소개(12자 내외)">
        </div>
		<?php } ?>
