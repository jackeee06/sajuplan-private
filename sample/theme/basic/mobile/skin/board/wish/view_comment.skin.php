    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-bottom-color:#f8f8f8"<?php } ?>>
        <div class="comment_inner">
            <header>
				...
				<div>
                    	<a href="../bbs/board.php?bo_table=counselor&wr_id=<?=$crow["wr_id"]?>"><img src="<?=$img?>" style="height:50px;">
						
						<!--<p class="review_user_img_item" style=" background-image:url(<?=$img?>);"></p>-->

						<?=$crow["ca_name"]?> | <?=$mb["mb_no"]?>
                ...
                <div class="bo_vl_opt">
                    ...
                    <ul class="bo_vc_act">
                        <!--
                         if ($list[$i]['is_reply']) { ?><li><a href="<?php echo $c_reply_href; ?>" onclick="comment_box('<?php echo $comment_id ?>', 'c'); return false;">답변</a></li> }
                        -->
