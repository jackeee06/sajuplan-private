            ...
            <div class="gall_li_wr">
                ...
                <div class="gall_text_href">
                    ...
                    <ul class="gall_li_tit">
                        ...
                        <p style="font-size:14px; color:#999; font-weight:400; margin-bottom:6px;">
                            ...
                            <span style=" display:inline-block; padding:2px 8px; background-color:#000; color:#fff; border-radius:50px; float:right; font-size:12px;">완료</span>
                        </p>
                ...
                <div class="gall_text_href">
                    ...
                    <ul class="gall_li_tit">
                        ...
                        <p style="font-size:14px; color:#999; font-weight:400; margin-bottom:6px;">
							...
							<span style=" display:inline-block; line-height:20px;">2024-08-09 · <span class="black"><span class="point f_600">3</span>/7일</span></span>
                            </a>
                            <span style=" display:inline-block; padding:2px 8px; background-color:#000; color:#fff; border-radius:50px; float:right; font-size:12px;">완료</span>
                        </p>
