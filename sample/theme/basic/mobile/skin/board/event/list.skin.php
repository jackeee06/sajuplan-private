		...
		?>
            ...
            <td class="td_subject" <?php if(!$img_content) { ?>colspan="2"<?php } ?>>
                ...
                <div class="bo_tit">
                    ...
                    <ul class="bo_tit_ul5"><?php echo $list[$i]['wr_1'] ?> ~ <?php echo $list[$i]['wr_2'] ?></ul>
                    
                    <ul class="bo_tit_ul2" style="display:none;">
                    ...
                    <ul class="bo_tit_ul3" style="display:none;">
                    ...
                    <ul class="bo_tit_ul4">
                        <li class="fl">
                            <span class="bo_names" style="display:none;"><?php echo $list[$i]['name'] ?></span>　
