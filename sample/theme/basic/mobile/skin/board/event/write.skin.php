...
<div class="form_01 write_div">
        ...
        <div class="write_div" style="display:flex; justify-content: space-between;">
        	<input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" required class="frm_input w_inputs datepicker required" placeholder="시작일" style="width:calc(50% - 5px);"> 
            <input type="text" name="wr_2" value="<?php echo $write['wr_2'] ?>" id="wr_2" required class="frm_input w_inputs datepicker required" placeholder="종료일" style="width:calc(50% - 5px);">
		</div>
