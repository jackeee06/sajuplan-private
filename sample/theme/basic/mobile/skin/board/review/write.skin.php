...
if(!$csr_id && !$write["wr_1"]){
	alert('상담사가 없습니다. 다시 확인해주세요!');
}
...
<section id="bo_w">
	...
	<input type="hidden" name="wr_1" value="<?php echo $csr_id ?>">
	<input type="hidden" name="wr_10" value="<?php echo $cno ?>">
	<input type="hidden" name="mymbid" value="<?php echo $mymbid ?>">
...
.write_div_radio_wrap .write_div_radio label { font-size:14px; color:#000;}
		...
		<div style=" width:100%; float:left; margin:10px 0 10px; font-size:14px; color:#666;">(후기 예시) 마음에 걸려 못하고 있던 고민까지 시원하게 상담해주셔서 감사합니다.</div>
    ...
    <p style="text-align:center; margin:20px 0; font-size:14px; color:#999;"><i class="xi-info-o" style="font-size:16px; vertical-align:-1px; margin-right:4px;"></i>솔직한 후기는 양질의 상담에 큰 도움이 됩니다</p>
    </form>
</section>
