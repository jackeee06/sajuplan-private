...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_info" style=" width:100%; float:left; padding:0 20px 20px;">
            <div style="float:right; ">
            <!--<a href="<?php echo $list_href ?>" class="btn black_bg white">-->
            
			<?if($member["mb_level"]>="5"){?>
				<a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=review&csrid=<?=$member["mb_id"]?>" class="btn black_bg white">목록보기</a>
			<?}else{?>
				<a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=review&mymbid=<?=$member["mb_id"]?>" class="btn black_bg white">목록보기</a>
			<?}?>
