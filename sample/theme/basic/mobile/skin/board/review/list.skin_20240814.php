...
<div class="con_section_03" >
    ...
    <div class="review_sort" style="">
        ...
        <ul class="review_sort_photo">
        	<input type="checkbox" id="photo_view" name="photo_view" value="Y" <?if($photo_view=="Y"){?>checked="checked"<?}?> onclick="search_enable_idle1();"/>
                ...
                <?php } ?>        
                    ...
                    <li class="review_user_score">
                        ...
                        <p class="review_user_id">
                       	    <span class="cate point"><?echo $crow['ca_name'];?></span>
                            <?=$mb["mb_nick"]?>
                            <!-- 상담사 고유번호 -->
              ...
              <!-- 작성자 정보 -->
           	  <ul class="review_user">
                  ...
                  <li class="review_user_score">
                      ...
                      <span class="review_info">상담시간 <?=$sa_info["usetm"]?gmdate("H시i분s초", $sa_info["usetm"]):'0';?></span>
					  <?}?>
              ...
              <ul class="review_con">
                  ...
                  <li class="review_con_text">
                		...
                		<div class="review_text">
                            ...
                            <ul>
                            	<span class="review_topic">상담주제: <?=$crow["ca_name"]?></span>
