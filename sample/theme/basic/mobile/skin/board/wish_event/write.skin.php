...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <div class="bo_w_tit write_div counselor_01">
        	<ul class="subject">진행상태</ul>
            <ul class="item">
            	<div class="input_wrap required" style=" width: 100px;">
        ...
        <div class="bo_w_tit write_div counselor_01">
            ...
            <ul class="item">
            	<div class="input_wrap required" style=" width: 100px;">
		            <label for="wr_subject" class="sound_only">기도기간<strong>필수</strong></label>
        		    <input type="number" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input right" placeholder="예시) 7" > &nbsp;&nbsp;일
            	</div>
				<script>
				$('#wr_subject').on('keyup', function() {
