...
<?php echo display_banner('일반-상담사신청', 'mainbanner.10.skin.php'); ?>


<div style=" text-align:center; padding:0px 20px 0; background-color:#f5f5f5; display:flex; justify-content: space-between; background-color:#3848c0; color:rgba(255,255,255,.8); border-top:1px solid rgba(0,0,0,.2);">
	<a href="tel:010-8702-9996" style="width:calc(50% - 5px); ">
	<ul style="font-size:14px; text-align:center; padding: 0 4px; line-height:40px; color:#fff;"><i class="xi-call" style="font-size:16px; vertical-align:-2px; margin-right:6px;"></i> 010-8702-9996</ul>
    </a>
    
    <a href="http://pf.kakao.com/_gLTVX" target="_blank" style="width:calc(50% - 5px); ">
	<ul style="font-size:14px; text-align:center; padding: 0 4px; border-radius:50px; line-height:40px; color:#fff;"><i class="xi-kakaotalk" style="font-size:18px; vertical-align:-2px; margin-right:6px;"></i> 1:1 문의</ul>
    </a>
</div>
            ...
            <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                ...
                <div class="bo_cnt">
                    ...
                    <a href="<?php echo $list[$i]['href'] ?>" class="bo_subject">
                        ...
                        <?php if ($list[$i]['wr_6']) { ?><span class="app_state">[<?php echo $list[$i]['wr_6'] ?>]</span><?php } ?>
