...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        <?php if($bo_table == 'way'){ // 사주의 길 링크 버튼 ?> 
        ...
        for ($i=1; $i<=count($view['link']); $i++) {
         ...
         ?>
                <a class="bo_v_con_link point_bg white" href="<?php echo $view['link_href'][$i] ?>" target="_blank">
                    <!--
                    <i class="fa fa-link" aria-hidden="true"></i>
                    <strong><?php echo $link ?></strong>
                    -->
                    기사 원문 보기 <i class="xi-long-arrow-right"></i>
                </a>
        <?php
            }
        }
