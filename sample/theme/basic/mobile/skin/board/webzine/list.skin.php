...
<fieldset id="bo_sch" style=" margin-bottom:0;">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>">
            <div class="gall_li_wr">
                ...
                <div class="gall_text_href">
                    ...
                    <p class="s_title" style="color:#999;"><?php echo $list[$i]['wr_1'] ?></p>
...
<?php if ($write_href) { ?>
    ...
    <div class="fix_btn write_btn" style=" bottom: 120px !important;">
