...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <div class="bo_w_tit write_div counselor_01">
        	<ul class="subject">사주일자</ul>
            <ul class="item">
	            <label for="wr_1" class="sound_only">사주일자<strong>필수</strong></label>
    	        <input type="date" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="frm_input full_input required" placeholder="날짜 선택" style="height:40px;">
            </ul>
        </div>

        <div class="bo_w_tit write_div counselor_01">
        	<ul class="subject">출생연도</ul>
            <ul class="item">
	            <label for="wr_subject" class="sound_only">출생연도<strong>필수</strong></label>
    	        <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" placeholder="예시)1982">
            </ul>
        </div>
        
        <div class="bo_w_tit write_div counselor_01">
        	<ul class="subject">띠</ul>
            <ul class="item">
	            <label for="wr_2" class="sound_only">띠<strong>필수</strong></label>
    	        <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="frm_input full_input required" placeholder="예시) 개">
            </ul>
        </div>

        <div class="bo_w_tit write_div counselor_01">
        	<ul class="subject">내용</ul>
            <ul class="item">
