...
<header id="hd">
    ...
    <div id="hd_wrapper">
		...
		<h2 id="container_title" class="top" title="<?php echo get_text($g5['title']); ?>">
            ...
            <a href="<?php echo G5_URL ?>/coin/coin_fill.php">
				<div class="hd_opener" id="gnb_open">
                	<span>360</span>
        			<img src="<?php echo G5_IMG_URL ?>/head/point.png" style="padding-top:6px;">
        		</div>
        	</a>
            </div>
            -->
            ...
            <ul class="haed_menu">
		        <li class="point">
        			<a href="<?php echo G5_URL ?>/coin/coin_fill.php">
	        			<img src="<?php echo G5_URL ?>/img/head/point.png" />
		                <span>360</span>
        		    </a>
		        </li>
        		<li class="push">
		        	<span class="dot"></span>
        		    <a href="<?php echo G5_URL ?>/sub/push_list.php">
		    	    	<img src="<?php echo G5_URL ?>/img/head/push.png" />
        		    </a>
		        </li>
		    </ul>
