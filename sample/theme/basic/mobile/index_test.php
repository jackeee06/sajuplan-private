...
if($_SERVER['REMOTE_ADDR'] == '115.93.39.5'){
    include_once(G5_THEME_MOBILE_PATH.'/index_dev.php');
    return;
}
...
-->
    ...
    <style>
        ...
        body.android-webview #count,
        body.android-webview #mcount{
            display:flex;
            align-items:center;
            height:30px;
        }

        body.android-webview .num{
            display:flex;
            align-items:center;
            justify-content:center;
            width:18px;
        ...
        body.android-webview .numList{
            line-height:30px;
        }

        body.android-webview .count_text{
            display:flex;
            align-items:center;
            height:30px;
            line-height:30px;
