...
#container_title .page_title { top:50%; left:50%; transform:translate(-50%,-50%); font-weight:500;}
</style>
...
<header id="hd">
    ...
    <div id="hdrapper">
		...
		<!--
	    <button type="button" id="gnb_open" class="hd_opener" style="z-index:2; top:10px;">
		...
		<h2 id="container_title" class="top bg_w" title="<?php echo get_text($g5['title']); ?>">
    		<a href="javascript:history.back();">
            	<img src="<?php echo G5_IMG_URL ?>/head/icon_back_w.png" style="width:24px;"/>
                <span class="sound_only">뒤로가기</span>
            </a> 
			
			<span class="page_title">추가관리 선택</span>
    	</h2>
