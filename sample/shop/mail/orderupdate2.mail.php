  ...
  <table width="600px" border="0" cellspacing="0" cellpadding="0" style="background-color:#FFF; border:10px solid #f8f8f9;">
            	...
            	<div style=" width:600px; float:left; position:relative;">
                	<span style="float:left;">
            			...
            			<p style="margin-top:20px;">
       	    			  <img src="https://sajumoon.co.kr/img/mail/orderupdate2_mail_title.png" style="width:280px;"> 	
                        </p>
                    </span>
        ...
        <p style="<?php echo $cont_st; ?>">배송지를 변경하실 고객님은 <b><?php echo  $default['de_admin_company_tel']; ?></b>로 연락주시기 바랍니다.</p>
                  ...
                  <p style="text-align:center; margin-top:20px;">
                    	<a href="<?php echo G5_SHOP_URL.'/orderinquiry.php'; ?>" target="_blank" style=" display:inline-block;padding:12px 60px; border-radius:5px; background:#465bf0;color:#fff;text-decoration:none;text-align:center; font-size:16px; font-weight:600; margin-top:10px;">
                        주문상세내역 확인
                  		</a>
                    </p>
