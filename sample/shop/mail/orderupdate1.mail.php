  ...
  <table width="600px" border="0" cellspacing="0" cellpadding="0" style="background-color:#FFF; border:10px solid #f8f8f9;">
            	...
            	<div style=" width:600px; float:left; position:relative;">
                	<span style="float:left;">
            			...
            			<p style="margin-top:20px;">
       	    			  <img src="https://sajumoon.co.kr/img/mail/orderupdate1_mail_title.png" style="width:280px;"> 	
                        </p>
                    </span>
        ...
        <tr>
          ...
          <p style="text-align:center; margin-top:20px;">
           	<a href="<?php echo G5_ADMIN_URL.'/shop_admin/orderform.php?od_id='.$od_id; ?>" target="_blank" style=" display:inline-block;padding:12px 60px; border-radius:5px; background:#465bf0;color:#fff;text-decoration:none;text-align:center; font-size:16px; font-weight:600; margin-top:10px;">
                        관리자 모드에서 주문 확인
       		</a>
                  </p>  
