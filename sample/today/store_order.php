...
<div class="con_section order_wrap con_section_b_bot_02">
	...
	<ul class="order_item">
        ...
        <li class="order_price">+ 490개</li>
    </ul>
    
    <ul class="order_item">
    	<li class="order_name">
        	<input type="radio" name="pro01" id="신년"><label for="신년"></label>신년
        </li>
        <li class="order_price">+ 990개</li>
    </ul>
    
    <ul class="order_item">
    	<li class="order_name">
        	<input type="radio" name="pro01" id="궁합"><label for="궁합"></label>궁합
        </li>
        <li class="order_price">+ 900개</li>
    </ul>
</div>
...
<div class="con_section order_wrap">
    ...
    <ul class="order_item">
    	<li class="order_name">
        	<input type="radio" name="pro02" id="부적" checked="checked"><label for="부적"></label>
        	부적
      </li>
        <li class="order_price">+ 1,000개</li>
    </ul>
    
    <ul class="order_item">
    	<li class="order_name">
        	<input type="radio" name="pro02" id="작명"><label for="작명"></label>작명
        </li>
        <li class="order_price">+ 2,000개</li>
    </ul>
</div>


<a href="store_order_02.php">
<div class="bottom_btn"><span class="point">1,290개</span>결제하기</div>
</a>
