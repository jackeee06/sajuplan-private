...
$sql_search = " where (1) and membid='".$cnum."' and reason='DISCONNECT'";
...
<input type="hidden" name="sfl" value="wr_datetime">
<div class="con_section sub_section_100 date_search">

	<ul>
        	<li class="input_date">
            	<input type="date"  data-placeholder="날짜 선택" required="required" aria-required="true" name="s_search_day">
            </li>
            
            <li class="input_date_line">~</li>
            
            <li class="input_date">
            	<input type="date" data-placeholder="날짜 선택" required="required" aria-required="true" name="e_search_day">
            </li>
            
            <li class="input_search" onclick="document.sfl.submit();"><i class="xi-search"></i></li>
    </ul>
</div>
        ...
        <div class="history_con">
            ...
            <div class="history_info_wrap">
            	<ul class="history_info">
                	<li class="history_info_01"><span>전화사주</span></li>
                    <li class="history_info_02">
						<?=$cinfo["mb_nick"]?>
                        <!-- 상담사 고유번호 -->
                        <?php include(G5_PATH.'/include/counselor_num.php'); ?>
                    </li>
                    <li class="history_info_03">코인상담 <span class="f_600"><?echo gmdate("H:i:s", $row["usetm"]);?></span></li>
                </ul>
                <ul class="history_btn_wrap">
                	<a href="#" class="history_btn">다시상담하기</a>
                    <a href="#" class="history_btn">상담내용보기</a>
                </ul>
            </div>
        </div>
