...
?>
	...
	<div class="history_wrap">
        ...
        <div class="history_con">
        	...
        	<a href="/bbs/board.php?bo_table=counselor&wr_id=<?=$crow["wr_id"]?>"><div class="history_img" style="background-image:url(<?=$img?>);"></div></a>
            ...
            <div class="history_info_wrap">
                ...
                <ul class="history_btn_wrap">
                    ...
                    <!--<a href="#" class="history_btn">채팅상담내용</a>-->
