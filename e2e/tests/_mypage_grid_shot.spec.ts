...
import fs from 'fs'
const SHOT = 'c:/claudeworkspace/sajumoon/e2e/_mypage'
...
test('mypage grid', async ({ page, context }) => {
  ...
  await page.goto('https://sajuplan.com/mypage/member')
  await page.waitForLoadState('domcontentloaded')
  await page.waitForTimeout(2000)
  await page.screenshot({ path: `${SHOT}/member.png`, fullPage: true })
})
