...
import { Search, Bell, Trash2, X } from 'lucide-react'
  ...
  return (
    <div className="space-y-3 max-w-[1100px]">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100">알림 이력 <span className="text-sm font-normal text-gray-400">(인앱·푸시 보낸 기록)</span></h1>
        <span className="text-xs text-gray-500">— 보내기는 <a href="/mng/push-notifications" className="text-brand-600 underline">알림 보내기(수동)</a></span>
      </div>

      <section className="space-y-2">
        <div className="flex items-center justify-between">
          <h2 className="text-sm font-semibold text-gray-700 dark:text-gray-200">보낸 알림 내역</h2>
