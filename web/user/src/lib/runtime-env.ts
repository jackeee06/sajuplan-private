 ...
 *
 *   VITE_SAJUMOON_ENV=test → https://sajumoon.kr      / https://api.sajumoon.kr     (테스트)
 *   VITE_SAJUMOON_ENV=prod → https://sajumoon.co.kr   / https://api.sajumoon.co.kr  (운영)
 *
 * 빌드 시:
 *   VITE_SAJUMOON_ENV=test npm run build
 *   VITE_SAJUMOON_ENV=prod npm run build
 */
