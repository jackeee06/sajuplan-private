    ...
    <div className="mobile-frame flex flex-col pb-[100px]">
      ...
      <main className="flex-1 px-4">
        <section className="pt-2 pb-5 flex items-center gap-3">
          ...
          <div className="flex flex-col items-end gap-1.5">
            {member.role === 'counselor' && (
              <Link
                to="/counselor/mypage"
                className="h-8 px-3 rounded-full bg-[#fdf2f8] border border-[#f472b6] flex items-center gap-1 text-[12px] font-semibold text-[#ec4899]"
              >
                상담사 메뉴
        ...
        <section className="rounded-[16px] bg-[#F9FAFB] px-5 pt-5 pb-2">
          <p className="text-[14px] leading-[140%] text-[#6A7282]">보유 코인</p>
          <div className="mt-1 flex items-center gap-2">
            <span className="text-[26px] leading-[130%] font-bold text-[#f472b6]">
              {point.toLocaleString()}
            </span>
            <span className="text-[14px] font-medium text-[#f472b6]">
              코인
            </span>
          </div>
